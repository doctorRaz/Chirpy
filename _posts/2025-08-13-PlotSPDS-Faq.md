...
<sub>Скачал Plot</sub> SPDS.exe, запускаю его, пишет " в наборе нет ни одного формата, нечего печатать", хотя на чертеже имеются форматы СПДС. Что я делаю не так? Нужно просто запустить Plot SPDS.exe при открытом автокаде?
