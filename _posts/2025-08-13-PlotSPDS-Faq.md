...
> <p>
> 
> Вы печатаете в <code>именованных</code> стилях, а программа может выводить на печать только в `цветозависимых`.
> 
> </p>
> </details> 
{: .prompt-info }
...
> Масштаб и <b>ориентация</b> определяются автоматически
> 
> </p>
> </details> 
{: .prompt-info }
