...
> <p>
> 
> переменную EPDFSHX сделать <b>0</b>
> 
> </p>
> </details> 
{: .prompt-info }
...
> Очевидно, что при печати со всего документа, сортировка по координатам смысла не имеет, \
> программа не учитывает порядок следования листов (taborder)
>
> </p>
> </details> 
{: .prompt-info }
...
> 
> <ol>
> <li> Запускаете программу (при запущенном АК и СПДС)
> <li> Заходите в шаблоны
> <li> Жмете кнопку обновить принтеры (справа вверху)
> <li> В нужном шаблоне выбираете принтер и формат листа, <br>
