...
> <li> Была удалена версия СПДС после установки новой. 
...
> - решение: т.к. у нас есть СПДС, то энаблер не нужен,<br/>
> переименовать файл <b>mcsEnabler.dbx</b>, расположенный в <br/>
