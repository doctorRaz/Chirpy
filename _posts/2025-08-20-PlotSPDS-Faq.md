...
[При попытке вывести на печать всплывает окно с ошибкой. В чем ошибка?](#stb)
![err](https://drive.google.com/open?id=0ByHQhhblPkuvMlJ5RmZmRnF6ak0)
...
[Да, вот еще что, если в чертеже используются листы А3 книжная и А3 альбомная ориентации, как настроить в шаблоне "правильную" печать?](#orientation)
