...
Удаление комментариев вынужденная мера, движок блога больше 200 показывать не умеет
doctorraz опубликовано 22:59:00
Поделиться
191 комментарий:

Анонимный18 сентября 2015 г. в 13:42
Андрей, добрый день!
Спасибо за утилиту!
При попытке вывести на печать всплывает окно с ошибкой. В чем ошибка?
https://drive.google.com/open?id=0ByHQhhblPkuvMlJ5RmZmRnF6ak0

Ответить
Ответы

doctorraz18 сентября 2015 г. в 17:17
Судя по ошибке очень похоже на то, что Вы печатаете в именованных стилях, а программа пока может выводить на печать только из цветозависимых.
Если это не так, то пришлите файл чертежа с ошибкой и фалы .*ini (находятся в c:\Users\ИмяПользователя\AppData\Roaming\PlotSPDS\) посмотрю в чем дело

Ответить

Анонимный19 сентября 2015 г. в 11:24
Да, вот еще что, если в чертеже используются листы А3 книжная и А3 альбомная ориентации, как настроить в шаблоне "правильную" печать?

Ответить
Ответы

doctorraz19 сентября 2015 г. в 15:25
никаких настроек не требуется, в шаблоне задаете желательный формат принтера для А3, ориентация определяется автоматически

Ответить

Unknown30 октября 2015 г. в 15:16
Скачал Plot SPDS.exe, запускаю его, пишет " в наборе нет ни одного формата, нечего печатать", хотя на чертеже имеются форматы СПДС. Что я делаю не так? Нужно просто запустить Plot SPDS.exe при открытом автокаде?

Ответить
Ответы

doctorraz30 октября 2015 г. в 15:22
Просто запустить при запущенном автокаде и открытом активном файле в котором есть форматы СПДС CS.
...
Unknown16 ноября 2015 г. в 13:40
