...
buttons:
  - text: Hierarchical Attention Networks
    image: {{ root_url | prepend: site.baseurl}}/assets/img/projects/2019NSR/HANarchitecture.png
  - text: HAN Attention Visualization
    image: {{ root_url | prepend: site.baseurl}}/assets/img/projects/2019NSR/HANattention.png
