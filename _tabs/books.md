  ...
  - title: "MenuFilesGen (Fork)"
    ...
    description:
      - приложение .NET для Windows, которое автоматизирует создание файлов конфигурации меню и ленты в nanoCAD.
        Система преобразует структурированные входные данные из электронных таблиц и текстовых файлов в специальные форматы конфигурации, необходимые для программного обеспечения nanoCAD, что избавляет от необходимости вручную создавать интерфейсы меню.
