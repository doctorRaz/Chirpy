...
books:
  - title: "MenuFilesGen (Fork)"
    ...
    description:
      ...
      - Программа преобразует структурированные входные данные из электронных таблиц или текстовых файлов в специальные форматы конфигурации, необходимые для программного обеспечения nanoCAD, что избавляет от необходимости вручную создавать интерфейсы меню.
